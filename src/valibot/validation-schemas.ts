...
export const Email = v.pipe(v.string(), v.trim(), v.email('Your email is invalid'));
...
export const RequiredString = (key: string) => v.pipe(v.string(), v.nonEmpty(`The ${key} field is required`));
